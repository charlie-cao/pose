...
class SimpleExampleAddons extends SimpleAddons {

	protected $version = '1.0';
	protected $author  = 'Charlie';
	protected $site    = 'http://www.zhaozhao.com';
	protected $info    = '当前所在位置';
	protected $pluginName = '地理信息插件';
